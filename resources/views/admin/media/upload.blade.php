                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.media.store') }}" method="POST" enctype="multipart/form-data" id="upload-form">
                        ...
                        <div class="mb-4">
                            ...
                            <div id="dropzone" class="mt-1 flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 px-6 py-12 transition-colors hover:border-indigo-400 hover:bg-indigo-50 cursor-pointer">
                                ...
                                <p class="mb-2 text-sm text-gray-500">
                                    <span class="font-semibold text-indigo-600">{{ __('Click to upload') }}</span>
                                    {{ __('or drag and drop') }}
                                </p>
                        ...
                        <div id="file-preview" class="mb-4 hidden">
                            <div class="flex items-center gap-4 rounded-lg border border-gray-200 bg-gray-50 p-4">
                                ...
                                <div class="w-32">
                                    ...
                                    <p id="progress-text" class="mt-1 text-xs text-gray-500">0%</p>
                                </div>
                            </div>
                        </div>

                        <div id="uploaded-files" class="mb-4 hidden">
                            <h4 class="mb-2 text-sm font-medium text-gray-700">{{ __('Uploaded Files') }}</h4>
