                ...
                <div class="p-6" style="color: var(--color-text-heading)">
                    <form action="{{ route('admin.tags.update', $tag) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $tag->name) }}" class="mt-1 block w-full rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" style="border-color: var(--color-border)" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="slug" id="slug" value="{{ old('slug', $tag->slug) }}" class="mt-1 block w-full rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" style="border-color: var(--color-border)" required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="3" class="mt-1 block w-full rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" style="border-color: var(--color-border)">{{ old('description', $tag->description) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="color" id="color" value="{{ old('color', $tag->color) }}" class="mt-1 block w-full rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" style="border-color: var(--color-border)" placeholder="#ffffff">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="status" id="status" class="mt-1 block w-full rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" style="border-color: var(--color-border)">
                                <option value="active" {{ old('status', $tag->status) == 'active' ? 'selected' : '' }}>{{ __('Active') }}</option>
                                <option value="inactive" {{ old('status', $tag->status) == 'inactive' ? 'selected' : '' }}>{{ __('Inactive') }}</option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="seo_title" id="seo_title" value="{{ old('seo_title', $tag->seo_title) }}" class="mt-1 block w-full rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" style="border-color: var(--color-border)">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="seo_description" id="seo_description" rows="3" class="mt-1 block w-full rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" style="border-color: var(--color-border)">{{ old('seo_description', $tag->seo_description) }}</textarea>
                        ...
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <form action="{{ route('admin.tags.destroy', $tag) }}" method="POST" class="inline-block">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="inline-flex items-center rounded-md bg-red-600 px-4 py-2 text-xs font-semibold uppercase tracking-widest text-white hover:bg-red-500" onclick="return confirm('{{ __('Are you sure you want to delete this tag?') }}')">
                                    {{ __('Delete Tag') }}
                                </button>
                            </form>
                        </div>
